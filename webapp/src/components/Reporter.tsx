...
export function Reporter({ meta }: ReporterProps) {
  ...
  return (
    <div className="flex flex-col gap-4 text-secondary">
      ...
      <div className="text-sm text-secondary text-left whitespace-pre-line">
        {truncatedMessage}
      </div>
      <div className="flex gap-3 flex-wrap w-fit">
        {meta.webLink && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1 px-3 py-1 text-sm border card-border rounded hover:opacity-80 transition-opacity"
          >
        ...
        {meta.privacyLink && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-3 py-1 text-sm border card-border rounded hover:opacity-80 transition-opacity"
          >
            プライバシーポリシー
          </a>
        )}
