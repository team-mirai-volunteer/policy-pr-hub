...
def test_needs_state_update_logic():
    ...
    updated_time_changed = local_data["basic_info"]["updated_at"] != github_data["updated_at"]
    merged_status_changed = local_data["basic_info"]["merged_at"] != github_data.get("merged_at")
    ...
    updated_time_changed2 = local_data2["basic_info"]["updated_at"] != github_data2["updated_at"]
    merged_status_changed2 = local_data2["basic_info"]["merged_at"] != github_data2.get("merged_at")
