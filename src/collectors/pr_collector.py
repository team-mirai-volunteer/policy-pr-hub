...
from ..utils.github_api import load_config, make_github_api_request, check_rate_limit, wait_for_rate_limit_reset
...
class PRCollector:
    ...
    def get_pr_list(self, state="all", sort="updated", direction="desc", per_page=100, page=1):
        """PRの一覧を取得する"""
    ...
    def collect_prs_by_update_time(self, output_dir=None, max_count=None, since=None):
        ...
        while True:
            prs = self.get_pr_list(sort="updated", direction="desc", per_page=per_page, page=page)
    ...
    def collect_prs_sequentially(self, start_number=1, end_number=None, output_dir=None):
        """連番でPRを収集する"""
        collected_count = 0
