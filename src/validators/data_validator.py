...
class DataValidator:
    ...
    def compare_stats(self, github_stats: Dict, local_stats: Dict) -> Dict:
        ...
        comparison["summary"] = {
            ...
            "coverage_percentage": (local_total / github_total * 100) if github_total > 0 else 0
        }
        ...
        sorted_labels = sorted(label_diffs.items(), 
    ...
    def generate_validation_report(self, comparison: Dict, output_file: Optional[str] = None) -> str:
        """検証レポートを生成"""
        print("検証レポートを生成中...")
    ...
    def validate_data(self, data_dir: Optional[str] = None, output_file: Optional[str] = None) -> Dict:
        """データ検証を実行"""
        print("データ検証を開始します...")
